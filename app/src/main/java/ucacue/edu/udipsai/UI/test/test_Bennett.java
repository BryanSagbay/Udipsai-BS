...
public class test_Bennett extends AppCompatActivity implements SerialListener, ServiceConnection {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button sendButton1 = findViewById(R.id.button_enviar_m1);
        Button sendButton2 = findViewById(R.id.button_enviar_m2);
        Button sendButton3 = findViewById(R.id.button_enviar_m3);
        ...
        sendButton1.setOnClickListener(v -> sendData("M1"));
        sendButton2.setOnClickListener(v -> sendData("M2"));
        sendButton3.setOnClickListener(v -> sendData("M3"));
